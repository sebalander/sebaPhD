...
# coords en acamara ref frame from map coords
x, y, z = R.dot(xym) + T
...
# %%
# de aca sale C11
(a*mx**2*r31**2 - 2*a*mx*r11*r31 + a*r11**2 + 2*b*mx*my*r31**2 - 2*b*mx*r21*r31 - 2*b*my*r11*r31 + 2*b*r11*r21 + c*my**2*r31**2 - 2*c*my*r21*r31 + c*r21**2)*xm**2

# de aca sale C12, C21
+ (2*a*mx**2*r31*r32 - 2*a*mx*r11*r32 - 2*a*mx*r12*r31 + 2*a*r11*r12 + 4*b*mx*my*r31*r32 - 2*b*mx*r21*r32 - 2*b*mx*r22*r31 - 2*b*my*r11*r32 - 2*b*my*r12*r31 + 2*b*r11*r22 + 2*b*r12*r21 + 2*c*my**2*r31*r32 - 2*c*my*r21*r32 - 2*c*my*r22*r31 + 2*c*r21*r22)*xm*ym
...
# de estas dos que siguen saco mux, muy
