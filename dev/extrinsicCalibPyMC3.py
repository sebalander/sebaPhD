...
xm, ym, Cm = cl.inverse(xi, yi, xAllOpt[:3], xAllOpt[3:], cameraMatrix, distCoeffs, model,
                     Ci, Cf, Ck, covOpt, Cfk)
...
allDelta = np.concatenate([[np.deg2rad(30)] * 3, [10] * 3])
allLow = xAllOpt - allDelta  # intrinsic
