...
X=np.zeros([len(X_train),tamNumN,tamNumN,1])
for i in range(n_ims):
    X[i,:,:,0]=cv2.resize(X_train[i,:,:,0],(tamNumN,tamNumN))
...
#
model.save('ModeloCompleto_7_5x5_tam10.h5')
model2.save('ModeloSinsoft_7_5x5_tam10.h5')
#
