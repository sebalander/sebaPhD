...
#
model.save('ModeloCompleto_6de7x7_varTam_2pool.h5')
model2.save('ModeloSinsoft_6de7x7_varTam_2pool.h5')

#
x= [X_train]
y= [y_tr]

np.save('X_train_varTam.npy',x)
np.save('y_train_varTam.npy',y)
